...
* A key insight for this problem is that we need to visualize the rotated arrays into a graph, which will helps us implement the conditions for shinking the search space. ![Example](../../.gitbook/assets/graph.png)
