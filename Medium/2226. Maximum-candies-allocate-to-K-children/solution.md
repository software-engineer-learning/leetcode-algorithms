# 2226. Maximum candies allocate to K children

## Intuition

* This question is similar to [Koko eating banana](https://github.com/software-engineer-learning/leetcode-algorithms/blob/main/Medium/875.KoKo-Eating-Bananas/solution.md) problem, it is highly recommended to study that problem as it is a pretty popular pattern in interview
