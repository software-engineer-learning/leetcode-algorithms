# <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="https://leetcode.com/problems/build-a-matrix-with-conditions/" target="_blank">2392. Build a Matrix With Conditions</a>

<p>&nbsp;</p><p>You are given a <strong>positive</strong> integer <code>k</code>. You are also given:</p>
